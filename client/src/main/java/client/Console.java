            ...
            switch (cmd) {
                ...
                case "register": {
                    try {
                        ...
                        if (argumentsParsed.length < 4) {
                            System.out.println("Usage: \"register\" <USERNAME> <PASSWORD> <EMAIL>");
                            break;
                        }
                        facade.register(argumentsParsed[1], argumentsParsed[2], argumentsParsed[3]);
                        loggedIn = true;
                        System.out.println(">> Registered! You are not logged in.");
                    } catch (Exception e) {
                ...
                case "login": {
                    try {
                        ...
                        facade.login(argumentsParsed[1], argumentsParsed[2]);
                        loggedIn = true;
